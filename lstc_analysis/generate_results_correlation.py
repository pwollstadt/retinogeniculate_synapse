...
def calculate_lstc(lais, lte, n_permutations):
...
def main():
    ...
    for n_pair in range(1, 18):
        ...
        corr = calculate_lstc(lais, lte, n_permutations=1000)
        print(f'Pearson corr: {0:.4f}, spearman r: {1:.4f}'.format(
            corr['corrcoef'], corr['spearmanr']))
